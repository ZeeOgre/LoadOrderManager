...
CREATE INDEX [ProfilePlugins_ProfilePlugins_idx_ProfilePlugins_PluginID] ON [ProfilePlugins] ([PluginID] ASC);
CREATE INDEX [ProfilePlugins_ProfilePlugins_idx_ProfilePlugins_ProfileID] ON [ProfilePlugins] ([ProfileID] ASC);
